...
**Tested up to:** 4.9
**Stable tag:** beta-1.0.29
**Requires PHP:** 5.6
**License:** MIT
**License URI:** https://github.com/mundipagg/woocommerce/blob/master/LICENS

## Este módulo está depreciado, não receberá novas funcionalidades ou correções e não deve ser instalado. Para saber mais informações, entre em contato com suporte@mundipagg.com. ##
